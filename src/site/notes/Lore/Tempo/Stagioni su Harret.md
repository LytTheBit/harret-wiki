...
## Stagione Piovosa
![Stagione Piovosa.png\|right\|200](/img/user/(0)%20Immagini/Lore/Stagione%20Piovosa.png)Stagione associata al [[Mondo/Erranti/Gelior/Pianeta di Gelior\|Pianeta di Gelior]], al acqua e al ghiaccio.
...
In questa stagione tendono inoltre a formarsi idrobolle in cielo.
...
## Stagione Rigogliosa
![Stagione Rigogliosa.png\|right\|200](/img/user/(0)%20Immagini/Lore/Stagione%20Rigogliosa.png)Stagione associata al [[Mondo/Erranti/Sylvara/Pianeta di Sylvara\|Pianeta di Sylvara]], alla terra e alla natura.
...
Anche gli animali sono particolarmente energici e fertili. Infatti questa è la stagione degli amori per molti animali.

Si dice che in questa stagione siano particolarmente comuni i gemelli.

> [!tip] Nota
> La Stagione Rigogliosa può essere paragonata alla nostra primavera. Ma sotto steroidi.

## Stagione Radiosa
![Stagione Radiosa.png\|right\|200](/img/user/(0)%20Immagini/Lore/Stagione%20Radiosa.png)Stagione associata al [[Mondo/Erranti/Luma/Pianeta di Luma\|Pianeta di Luma]] e alla luce.
...
La magia divina, non solo delle divinità di questo periodo, è tendenzialmente più forte. E si festeggiano molte feste in onore di santi e dei. 

Si produce meno raccolto rispetto alla Stagione Rigogliosa, ma alcuni sostengono che i prodotti siano più succosi e saporiti.

> [!tip] Nota
> La Stagione Radiosa può essere paragonata alla prima estate, con giornate lunghe e luministe ma non ancora troppo calde.

## Stagione Afosa
![Stagione Afosa.png\|right\|250](/img/user/(0)%20Immagini/Lore/Stagione%20Afosa.png)Stagione associata al [[Mondo/Erranti/Ignar/Pianeta di Ignar\|Pianeta di Ignar]] e al fuoco.
Terza stagione del anno.
...
## Stagione Ventosa
![Stagione Ventosa.png\|right\|200](/img/user/(0)%20Immagini/Lore/Stagione%20Ventosa.png)Stagione associata al [[Mondo/Erranti/Venthar/Pianeta di Venthar\|Pianeta di Venthar]], al aria e il vento.
...
Non sono rari veri e propri tornadi. Chiamati *"tifoni"*. Sono meno pericolosi di quanto si possa credere, ma vengono tenuti sotto stretta osservazione da meteorologi e maghi.

> [!tip] Nota
> La Stagione Ventosa può essere paragonata al nostro autunno.

## Stagione Ombrosa
![Stagione Ombrosa.png\|right\|250](/img/user/(0)%20Immagini/Lore/Stagione%20Ombrosa.png)
Stagione associata al [[Pianeta di Noctharì\|Pianeta di Noctharì]], al oscurità e alle ombre.
Sesta stagione del anno.

Durante questa stagione le notti solo lunghe e le giornate corte. In alcune zone vicino ai poli il sole non sorge neanche.
...
![Stagioni su Harret.jpeg](/img/user/(0)%20Immagini/Lore/Stagioni%20su%20Harret.jpeg)
